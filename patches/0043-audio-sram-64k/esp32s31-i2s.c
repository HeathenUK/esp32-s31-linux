 ...
 * shared by playback and capture - so the pool is 64 KiB, and that 32 KiB of
 * growth came out of hart0's heap. See shared/s31_memory_layout.h for the
 * headroom measurement and the warning that the LOADER carries this map too.
 */
